...
The exploration of the boundary of the floating shape using regression.
"""
...
class Image(object):
    def __init__(self,dir = "/home/jw/code/dyna-shape-tracking/fig/"):
        self.image_png = misc.imread(dir+"pic.png")
        self.image_mat = sio.loadmat(dir+"Jaysmatrix.mat")
        "self.image_mat is a dict now, we only need the 'matrix' pair."
        self.image_mat = self.image_mat['matrix']

    def png_to_np(self):
        return np.array(self.image_png)

    # def parse_the_image(self, dir = "/home/jw/code/dyna-shape-tracking/fig/*.png"):
    #     for image_path in glob.glob(dir):
    #         image = misc.imread(image_path)
    #     print "HAAHA", image.shape
    #     return image
